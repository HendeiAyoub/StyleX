...
enum DemoStore {
  ...
  static let products: [Product] = [
    ...
    Product(id: 161, categoty: "tops", imageUrl: "https://images.unsplash.com/photo-1485968579580-b6d095142e6e?w=500", price: 34.00, title: "Pleated Chiffon Camisole", description: "Delicate pleated chiffon camisole with adjustable spaghetti straps.", isPromotion: false, valuePromotion: 0, colors: [AIColor(hexCode: "#f9f6f0", label: "cream", dominance: 88.0)], embedding: localEmbedding(for: 161)),
